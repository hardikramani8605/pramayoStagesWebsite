...
import UiUxService from "../page/service/UiUxService.jsx";
import ApplicationService from "../page/service/ApplicationService.jsx";
import WebService from "../page/service/WebService.jsx";
import AugmentedRealityService from "../page/service/AugmentedRealityService.jsx";
		...
		children: [
			{
				...
				children: [
					...
					{
                       path:"/augmentedreality-service",
					   element:<AugmentedRealityService/>
					},
					{
						path: "/team",
						element: <Team />,
